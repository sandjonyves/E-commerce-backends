...
def group_permissionOfcathegorie_piece():
    ...
    marchandGourpPermission =Group(name='marchandGourpPermission')
    marchandGourpPermission.save()
    marchandGourpPermission.permissions.set(create_permission)

    return marchandGourpPermission
